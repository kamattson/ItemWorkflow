...
INSERT INTO Item
    ([ItemId],[Name], [ArticleSourceFlag], [Vendor], [ApprovalStatus], [LastUpdateDate])
VALUES
...
SELECT i.ItemId, i.Name, i.ArticleSourceFlag, i.Vendor, i.ApprovalStatus, i.LastUpdateDate
FROM dbo.Item as i
GO